...
func TestCard(t *testing.T) {
	...
	_ = question1.Answer(true). //Creates an answer object with multiselect true or false. Must be after Question and not before
					...
					SetHeaderToAnswer(2, app.FULLCARD).                        //Sets the header for the card object
					...
					SetHeaderToAnswer(2, app.FULLCARD). //Header for the above card
	...
	_ = strike.Question("Key2"). //Another question with context as key2
					...
					SetHeaderToQuestion(2, app.HALFCARD). //Observe Question without answer is allowed but Answer without Question is not
